...
Python developer working at the intersection of ML, data science, and agentic AI. I build things that automate decisions, understand language, and occasionally break prod in interesting ways.
...
- Agentic AI pipelines that actually do useful things end-to-end
- ML systems for language detection, recommendations, sentiment analysis
- Automation tools that replace repetitive workflows

Most of my interesting work is at the layer where LLMs meet real systems — tool calling, memory, structured outputs, agent orchestration.
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=flat&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/srikant-sriniwasan-3a70a228b)

---

*B.Tech CS @ IEM Kolkata — open to internships and SDE/ML roles*
